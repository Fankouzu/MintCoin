...
module.exports = async (deployer, network, accounts) => {
    ...
    //布署锁仓合约
    const IssueTokenBeforeTimelockInstance = await deployer.deploy(
        IssueTokenBeforeTimelock,
    ...
    await ERC20FixedSupplyInstance.transfer(
        IssueTokenBeforeTimelockInstance.address,
